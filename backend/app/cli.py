...
def render(structure, out_png, out_glb, size, scale, display, render_style, transparent, background, brightness, scene, no_gizmo, do_build):
    ...
    try:
        result = render_browser.render_structure(
            ...
            scene=scene, hide_gizmo=no_gizmo,
        )
