...
export function SelectionActionBar() {
  ...
  // When a multi-frame trajectory is loaded, TrajectoryBar sits bottom-center
  // (bottom: 16, ~56px tall). Lift this bar above it so the two don't overlap.
  ...
  return (
    <Paper
      ...
      sx={{ position: 'absolute', bottom: frameCount > 1 ? 88 : 24, left: '50%', transform: 'translateX(-50%)', px: 2, py: 1, borderRadius: 3, zIndex: 5 }}
    >
