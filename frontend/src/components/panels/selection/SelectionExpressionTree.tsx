...
import { Box, Typography, Chip, useTheme, alpha, Paper, IconButton, Collapse, Tooltip } from '@mui/material';
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column' }}>
      ...
      >
        ...
        {/* Node Content — tooltip advertises the double-click-to-pin gesture */}
        <Tooltip title="Double-click to pin/unpin">
          <Chip
            aria-label="Double-click to pin/unpin"
            label={label}
            color={color}
            variant={variant}
            size="small"
            // Always provide onClick so MUI Chip renders as role="button" (required for
            // a11y and for Tooltip to work on non-interactive children).
            // For leaf nodes (no children), clicking is a no-op; double-click still pins.
